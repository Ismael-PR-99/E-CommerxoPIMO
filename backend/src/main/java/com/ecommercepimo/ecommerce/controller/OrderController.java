...
/**
 * Controlador de pedidos con validación completa
 */
@RestController
...
public class OrderController {
    ...
    /**
     * Obtener todas las �rdenes (solo admins)
    ...
    /**
     * Obtener �rdenes por estado (solo admins)
    ...
    /**
     * Obtener estad�sticas mensuales (solo admins)
